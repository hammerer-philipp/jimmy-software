        ...
        <Reveal className="lg:col-span-6">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Hey, ich bin Philipp. Durch Jimmy Ausbildung, mein eigenes SaaS, kennen wir den Startup-Alltag. Diese Praxiserfahrung nutzen wir, um Gründer schnell und kosteneffizient zu einem marktreifen MVP zu führen – ohne hohe Anfangskosten. Da wir wissen, dass das Budget zu Beginn oft knapp ist, bieten wir eine überschaubare Anzahlung im mittleren vierstelligen Bereich und nehmen dafür eine Umsatzbeteiligung. Ideal für Teams ohne eigenen Tech‑Co‑Founder, denn so bleiben die Anfangskosten gering und das Risiko überschaubar.
            </p>
